<div class="container-fluid borde-inferior bg-white">
        <nav class="container navbar navbar-expand-lg navbar-light">              
            ...
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('/images/logo.png')); ?>" class="logo d-inline-block" alt="optolan technology"> 
            </a>
    ...
    </div><?php /**PATH /home/gj1ldjyb/public_html/laravel/resources/views/comun/front/menu.blade.php ENDPATH**/ ?>