<div class="container-fluid bg-gris py-5">
    <div class="container">
        ...
        <div class="col-md-12">
            <form action="<?php echo e(url('newsletter')); ?>" method="POST" id="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/gj1ldjyb/public_html/laravel/resources/views/comun/front/newsletter.blade.php ENDPATH**/ ?>