                                ...
                                <div class=" col-12">
                                    <div class="row ">
                                        <div class="col-4 mb-3">    
                                            ...
                                            <input class="form-control" list="cliente" id="exampleDataList" name="cliente_id" placeholder="Nombre cliente..." required>
                                            <datalist id="cliente">
                                        ...
                                        <div class="col-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="fallo" id="validationTooltip02" required>
                                            <div class="valid-feedback">
...
<?php echo $__env->make('layouts.incidencia.incidencia', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\SPMiguel\resources\views/front/operario/incidencias/crear.blade.php ENDPATH**/ ?>