<?php $__env->startSection('cuerpo'); ?>
    <div class="container-fluid">               
            ...
            <div class="modal-content">
                <div class="modal-body">                            <!--Cambiar ruta-->
                    <form class="needs-validation " novalidate action="<?php echo e(route('operario.store')); ?>" method="POST" enctype="multipart/form-data"> 
                        <?php echo csrf_field(); ?>         
                        <div class="row">
                            <div class="col-12 ">
                            ...
                            <div class="col-12 py-3">
                                <div class="row px-3 ">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="validationTooltip01" name="n_unidadades" >
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" name="fecha" id="validationTooltip02" >
                                        <div class="invalid-feedback">
                                    ...
                                    <div class=" col-12">
                                        <div class="row ">
                                            ...
                                            <div class="col-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="cliente_id" id="validationTooltip02" value="" disabled >
                                                <div class="valid-feedback">
...
<?php echo $__env->make('layouts.incidencia.incidencia', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\SunproPrivado\resources\views/front/operario/incidencias/crearCliente.blade.php ENDPATH**/ ?>