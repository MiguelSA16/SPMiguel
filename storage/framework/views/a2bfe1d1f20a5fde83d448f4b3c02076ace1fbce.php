        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class=" border ">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('register')); ?>" id="form-registro">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="empresa"  value="<?php echo e(old('empresa')); ?>" required autocomplete="empresa" autofocus>
