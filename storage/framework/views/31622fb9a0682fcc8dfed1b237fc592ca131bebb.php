                        ...
                        <div class="col-7">                    
                            ...
                            <table class="table table-striped ">
                                <tbody>
                                    ...
                                    <!--
                                    <?php if($articulo->oferta=='SI'): ?>
                                        <tr class=" border-bottom">
                                            <th class="text-uppercase ">
                                                PVP Oferta:
                                            </th>
                                            <th class="text-primary"> 
                                                <?php echo e($articulo->pvpoferta); ?> € <small>und.</small> 
                                            </th>
                                            <td colspan="2">                                            
                                            </td>
                                        </tr>
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                           ...
                                           <!-- <tr>
                                                    <th colspan="4"> 
                                                        ...
                                                        <span class=" d-block">
                                                            stock : <?php echo e($articulo->stock[0]->total); ?> 
                                                        </span> 
                                                    </th>
                                                </tr> -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gj1ldjyb/public_html/laravel/resources/views/front/articulos/ver.blade.php ENDPATH**/ ?>