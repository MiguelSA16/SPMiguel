                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(Auth::user()->role_id == 3): ?>
                                                <tr class=" border-bottom">
                                                    ...
                                                    <?php if( precioCliente(Auth::user()->cliente_id,$articulo->codigo) != null): ?>
                                                        <?php if($pvp1 <= precioCliente(Auth::user()->cliente_id,$articulo->codigo)): ?>
                                                            <span class=" d-block">
                                                                <!--<strike style="font-size: 14px;font-weight: normal;"  >-->
                                                                     <?php echo e(number_format((precioCliente(Auth::user()->cliente_id,$articulo->codigo)*2),2)); ?>€
                                                                <!--</strike>--> 
                                                                     <small>und.</small>
                                                            </span>                                                      
                                                            
                                                            <!--<span class=" text-danger">
                                                                <?php echo e(precioCliente(Auth::user()->cliente_id,$articulo->codigo)); ?>€ <small>und.</small> 
                                                            </span>-->
                                                        <?php else: ?>
                                                            <span class=" d-block">
                                                                <!--<strike style="font-size: 14px;font-weight: normal;" > -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SPMiguel\resources\views/front/articulos/ver.blade.php ENDPATH**/ ?>