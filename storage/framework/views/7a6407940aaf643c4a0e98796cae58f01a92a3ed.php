                    ...
                    <div class="row px-3 ">
                        <div class="col-6 mb-3">
                            <h5 class="font-weight-bold">Proveedor/Cliente</h5> 
                                <p  class="text-muted form-control-file"><?php echo e(nombreCliente($incidencia->cliente_id)); ?> </p>         
                        </div>     
                        <div class="col-6 mb-3">
...
<?php echo $__env->make('layouts.incidencia.incidencia', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\SPMiguel\resources\views/front/operario/incidencias/show.blade.php ENDPATH**/ ?>