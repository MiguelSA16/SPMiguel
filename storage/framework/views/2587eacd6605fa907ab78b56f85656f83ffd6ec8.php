            ...
            <?php $__currentLoopData = $incidencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incidencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="text-uppercase"><?php echo e(nombreUsuario($incidencia->users_id)); ?></span>
                    ...
                    <td >
                        ...
                        <?php else: ?>
                            ...
                            <button type="button" class="btn btn-success btn-sm btn-block text-capitalize" style="width:105px;"><?php echo e($incidencia->realizado_por); ?></button>                      
                    ...
                    <td>
                        ...
                        <?php if($incidencia->prioridad == 'Baja'): ?>
                            ...
                            <button type="button" class="btn btn-info btn-sm btn-block  text-capitalize" style="width:105px;"><?php echo e($incidencia->prioridad); ?></button>

                        <?php elseif($incidencia->prioridad == 'Media'): ?>

                            <button type="button" class="btn btn-warning btn-sm btn-block  text-capitalize" style="width:105px;"><?php echo e($incidencia->prioridad); ?></button> 

                        <?php elseif($incidencia->prioridad == 'Alta'): ?>

                            <button type="button" class="btn btn-danger btn-sm btn-block  text-capitalize" style="width:105px;"><?php echo e($incidencia->prioridad); ?></button> 
...
<?php echo $__env->make('layouts.incidencia.incidencia', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\SPMiguel\resources\views/front/operario/incidencias/index.blade.php ENDPATH**/ ?>