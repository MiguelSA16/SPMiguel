...
class FrontController extends Controller
{
    ...
    public function get_categorias($url_familia){
        ...
        $familia_actual = Familia::where('slug',$url_familia)
            ->first();        
    ...
    public function get_articulos(Request $request, $url_familia){        
        ...
        //$articulos = new ArticuloCollection(Articulo::selectRaw('* , count("codigo") as art')
    ...
    public function ver_articulo($url_articulo){
        ...
        $articulo = new AppArticulo(Articulo::where("slug",$url_articulo)
            ->first());   
