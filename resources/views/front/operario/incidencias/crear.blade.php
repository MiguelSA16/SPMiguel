    ...
    <div class="container-fluid">               
        ...
        <div class="modal-content">
            <div class="modal-body">                            
                <form class="needs-validation " novalidate action="{{ route('operario.incidencias')}}" method="POST" enctype="multipart/form-data"> 
                    @csrf         
                    <div class="row">
                        <div class="col-12 ">
                                        ...
                                        <div class="col-4 mb-3">    
                                            ...
                                            <datalist id="cliente">
                                                @foreach ($clientes as $item)
                                                    <option value="{{$item->clacli}}">{{$item->nombre}}</option>                                                    
                                                 @endforeach
                                            </datalist>                                     
                                            <div class="invalid-feedback">
