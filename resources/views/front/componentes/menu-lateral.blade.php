<nav id="sidebarMenu" class=" d-md-block sidebar collapse bg-dark " >
    ...
    @if (Auth::user()->role_id == 3)
        <ul class="nav flex-column mb-2 ">
            <li >
                <a class="nav-link" href="{{ route('cliente.incidencias')}}" >  
            ...
            <li >
                <a class="nav-link" href="{{ route('cliente.incidencias.create')}}">
                    <button type="button" class="btn btn-outline-light btn-block ">
    ...
    @if (Auth::user()->role_id == 5)
        <ul class="nav flex-column mb-2 ">
            <li >
                <a class="nav-link" href="{{ route('operario.incidencias')}}" > 
                    <button type="button" class="btn btn-outline-light btn-block">
                        <i class="fas fa-list-ul"></i>
                        Ver incidencias
                    </button>              
            ...
            <li >
                <a class="nav-link" href="{{ route('operario.incidencias.create')}}">
                    <button type="button" class="btn btn-outline-light btn-block ">
                        <i class="fas fa-plus-circle"></i>
                        Crear incidencia
                    </button>              
