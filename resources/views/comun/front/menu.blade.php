<div class="container-fluid borde-inferior bg-white">
        ...
        <nav class="container navbar navbar-expand-lg navbar-light">              
            ...
            <a class="navbar-brand" href="{{url('/')}}">
                ...
                <img src="{{asset('/images/logo.png')}}" class="logo d-inline-block" alt="sunpro redes y sistemas"> 
                ...
                <form method="GET" action="{{url('/search')}}" class="form-inline my-2 my-lg-0">
                    ...
                    <div class=" input-group">
                        ...
                        @if (isset($cad_buscada))
                            ...
                            <input class="form-control " type="search" placeholder="Buscar" aria-label="Buscar" name="q" value="{{$cad_buscada}}">
